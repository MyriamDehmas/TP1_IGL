...
/**
 * this is the Test class for the class VectorHelper
 * each method of VectorHelper has its test method here
 * the headers of the methods were automatically generated , but needed to add Test suffix to the methods names
 * since it doesn't come automatically with JUnit 4 (needs settings)
 *
 */
